...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    private boolean isAuthorized(String role, String path, String method) {
        if ("ADMIN".equalsIgnoreCase(role)) {
            return path.startsWith("/patients") || path.startsWith("/hospitals") || path.startsWith("/departments") || path.startsWith("/bookings");
        } 
        else if ("PATIENT".equalsIgnoreCase(role)) {
            return (path.startsWith("/patients") || path.startsWith("/bookings") && (method.equalsIgnoreCase("GET") || method.equalsIgnoreCase("POST") || method.equalsIgnoreCase("PUT")));
        }
        return false;
    }
